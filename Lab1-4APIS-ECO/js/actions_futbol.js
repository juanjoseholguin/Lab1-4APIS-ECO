// FÚTBOL — Equipos por nombre con fallback de coincidencia parcial
...
// --- Catálogo para fallback parcial (se cachea en memoria) ---
...
async function onSearchTeams(){
  ...
  try{
    ...
    if (!list.length){ // fallback parcial por catálogo
