// Pokémon — soporta nombre parcial
...
async function getAllNames(){ // ~1300, pero solo nombres/urls
...
async function onSearchPokemon(){
  ...
  showLoading(outId);
  try{
    if(name){ // primero intento exacto
      ...
      // fallback: coincidencia parcial por nombre
